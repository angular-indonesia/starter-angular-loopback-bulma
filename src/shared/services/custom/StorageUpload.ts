...
/**
 * Api services for the `StorageUpload` model.
 */
@Injectable()
export class StorageUploadApi extends BaseLoopBackApi {
   ...
   * <em>
   * (The remote method definition does not provide any description.
   * This usually means the response is a `StorageUpload` object.)
   * </em>
   */
  ...
  public getFiles(container: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/StorageUploads/:container/files";
    let _routeParams: any = {
      container: container
    };
    let _postBody: any = {};
  ...
  public getFile(container: any = {}, file: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/StorageUploads/:container/files/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
  ...
  public upload(req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/StorageUploads/:container/upload";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
  ...
  public download(container: any = {}, file: any = {}, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/StorageUploads/:container/download/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
